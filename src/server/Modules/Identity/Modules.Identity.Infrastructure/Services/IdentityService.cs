// --------------------------------------------------------------------------------------------------
// <copyright file="IdentityService.cs" company="AccentDesign">
// </copyright>
// --------------------------------------------------------------------------------------------------
...
namespace Modules.Identity.Infrastructure.Services
{
    public class IdentityService : IIdentityService
    {
            ...
            if (userWithSameEmail == null)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (_mailSettings.EnableVerification)
                    {
                        ...
                        {
                            From = "mail@accentdesign.co.uk",
                            To = user.Email,
                            Body = string.Format(_localizer["Please confirm your Accent account by <a href='{0}'>clicking here</a>."], emailVerificationUri),
                    ...
                    if (_smsSettings.EnableVerification)
                    {
                        ...
                        var smsRequest = new SmsRequest
                        {
                            ...
                            Message = string.Format(_localizer["Please confirm your Accent account by this code: {0}"], mobilePhoneVerificationCode)
                        };
        ...
        private async Task<string> GetEmailVerificationUriAsync(AccentUser user, string origin)
        {
        ...
        private async Task<string> GetMobilePhoneVerificationCodeAsync(AccentUser user)
        {
