// --------------------------------------------------------------------------------------------------
// <copyright file="TokenService.cs" company="AccentDesign">
// </copyright>
// --------------------------------------------------------------------------------------------------
...
namespace Modules.Identity.Infrastructure.Services
{
    public class TokenService : ITokenService
    {
        ...
        private async Task<string> GenerateJwtAsync(AccentUser user, string ipAddress)
        {
            return GenerateEncryptedToken(GetSigningCredentials(), await GetClaimsAsync(user, ipAddress));
        }

        private async Task<IEnumerable<Claim>> GetClaimsAsync(AccentUser user, string ipAddress)
        {
