// --------------------------------------------------------------------------------------------------
// <copyright file="IdentityDbContext.cs" company="AccentDesign">
// </copyright>
// --------------------------------------------------------------------------------------------------
...
namespace Modules.Identity.Infrastructure.Persistence
{
    public sealed class IdentityDbContext : IdentityDbContext<AccentUser, AccentRole, string, IdentityUserClaim<string>, IdentityUserRole<string>, IdentityUserLogin<string>, FluentRoleClaim, IdentityUserToken<string>>,
        ...
        IExtendedAttributeDbContext<string, AccentRole, RoleExtendedAttribute>
    {
        ...
        DbSet<AccentUser> IExtendedAttributeDbContext<string, AccentUser, UserExtendedAttribute>.GetEntities() => Users;

        DbSet<UserExtendedAttribute> IExtendedAttributeDbContext<string, AccentUser, UserExtendedAttribute>.ExtendedAttributes { get; set; }

        DbSet<AccentRole> IExtendedAttributeDbContext<string, AccentRole, RoleExtendedAttribute>.GetEntities() => Roles;

        DbSet<RoleExtendedAttribute> IExtendedAttributeDbContext<string, AccentRole, RoleExtendedAttribute>.ExtendedAttributes { get; set; }
    }
}