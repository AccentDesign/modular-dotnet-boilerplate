// --------------------------------------------------------------------------------------------------
// <copyright file="ExtendedAttributeCommandHandler.cs" company="AccentDesign">
// </copyright>
// --------------------------------------------------------------------------------------------------
...
#pragma warning restore RCS1046 // Asynchronous method name should end with 'Async'.
        {
            ...
            extendedAttribute.AddDomainEvent(new ExtendedAttributeRemovedEvent<TEntityId, TEntity>(command.Id));
            await _context.SaveChangesAsync(cancellationToken);
